...
// Import MUI Reset first to override default MUI styles
import "../src/styles/MuiReset.css";
// Then import our custom styles
import "../src/styles/DarkTheme.css";
import "../src/styles/AdminCustom.css"; // New admin custom styles
import "../src/styles/DashboardDark.css";
import "../src/styles/DataGridDark.css";
import "../src/styles/SettingsManagement.css"; // Settings panel styles
import "../src/styles/PremiumSidebar.css"; // Premium sidebar styles
import "../src/styles/PremiumNavbar.css"; // Premium navbar styles
...
import AdminDashboard from "./components/admin/ModernDashboard";
import StaffDashboard from "./components/staff/Dashboard";
import MobileStaffDashboard from "./components/staff/MobileStaffDashboard";
import ClientManagement from "./components/admin/ModernClientManagement";
import StaffManagement from "./components/admin/ModernStaffManagement";
